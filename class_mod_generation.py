...
def generate(rarity, level):
    ...
    class_mod_info = {
        'stat_changes': class_mod_module.get_stat_changes(class_mod_type, rarity, level),
        'skill_point_changes': class_mod_module.get_skill_point_changes(class_mod_type, rarity, level)
    }
